...
export const MARKETING_FEATURES: MarketingFeature[] = [
  ...
  },
  {
    ...
    title: "Health check",
    description:
      "GET /api/v1/health — liveness endpoint for deploy smoke tests and uptime monitors.",
    icon: Activity,
    demoHref: "#health",
  },
  {
    ...
    description:
      "Resend email when a job run fails (network errors). Worker sends after logging the failure.",
    icon: BellRing,
    demoHref: "#alerts",
  },
  {
    ...
    description:
      "Reset link by email with a signed token — request and set a new password from the auth UI.",
    icon: Mail,
    demoHref: "#auth-demo",
  },
  {
  ...
  },
  {
    ...
    description: "Checkout and webhooks — not in scope for this learning project.",
    icon: CreditCard,
    demoHref: "#pricing",
  },
  {
...
export const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    desc: "BullMQ repeat jobs fire on schedule. A dedicated worker executes each HTTP call.",
    demoHref: "#cron",
    ...
    preview: `// Scheduler registers repeat job
{
  ...
  },
  {
    ...
    step: "03",
    title: "Inspect & alert",
    desc: "Browse run history in the dashboard. Email alerts on failure are live; chat webhooks ship later.",
    demoHref: "#logs-demo",
    demoLabel: "Logs demo",
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Free plan allows 3 active jobs. Creating a 4th returns 403 Plan limit reached. Limits are enforced in the API; paid billing is not implemented.",
